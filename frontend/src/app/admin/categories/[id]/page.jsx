...
const DashboardCategoryDetails = () => {
  ...
  return (
    <Box sx={{ pb: 4 }}>
      ...
      <Box sx={{ mb: 4 }}>
        <Breadcrumbs sx={{ mb: 2 }}>
          <Link underline="hover" color="inherit" onClick={() => router.push('/admin/categories')} sx={{ cursor: 'pointer' }}>
            Categories
          </Link>
        ...
        <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2 }}>
            <IconButton onClick={() => router.push('/admin/categories')} color="primary">
              <ArrowBackIcon />
            </IconButton>
